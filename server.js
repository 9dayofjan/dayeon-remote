...
const server = http.createServer((req, res) => {
    ...
    if (pathname === '/api/version') {
        ...
        let verData = Object.assign({ version: 690, updatedDate: '2026-08-26 01:00:00', updatedAt: Date.now(), files: ['fastcap.exe', '다연원격_클라이언트.exe', 'agent.js', 'input_ctrl.exe', 'audiocap.exe', 'NAudio.dll', '다연코퍼레이션.exe', 'version.json', 'server_ip.txt'] }, cachedVersion);
